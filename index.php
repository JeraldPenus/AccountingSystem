...
var urlPath="http://localhost/AccountingSystem/";
...
<!-- jQuery library -->
<script src="css/jquery-ui-1.11.4/jquery.min.js"></script>
...
<br><br><br><br><br><br><br><br><h4 style="font-size: 50px;margin-bottom: 0px;margin-top: 0px;padding-left: 30px;">Transaction and Statements</h4>
</section>
<body onLoad="javascript:defaultDisplay();dcfy();">

<nav class="navbar navbar-info" style="margin-bottom: 20px;">
...
<ul class="nav navbar-nav navbar-right">
                  <li class="dropdown">
                    <a href="#" data-target="#" class="dropdown-toggle" data-toggle="dropdown"><?php 
		...
		<li><a href="addAccount.php">&nbsp;Manage Account Details</a></li>
		<li><a href="index.php">&nbsp;Transactions and Statements</a></li>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" id="dbModalBody">
          <div id="saveDayBook" class="form-horizontal" role="form">
			  ...
			  <button class="btn btn-raised btn-info" onClick="saveAccounts();return false;">Save</button>
			</div>
        </div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
			<div class="form-horizontal" role="form">
				  ...
				  <button class="btn btn-raised btn-info" onClick="showLedger(1);return false;">Submit</button>
			</div>
		</div>
		<div class="modal-footer">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
			<div class="form-horizontal" role="form">
				  ...
				  <button class="btn btn-raised btn-info" onClick="showTrialBalance(1);return false;">Submit</button>
			</div>
		</div>
		<div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
			<div class="form-horizontal" role="form">
				  ...
				  <button class="btn btn-raised btn-info" onClick="showBalanceSheet(1);return false;">Submit</button>
			</div>
		</div>
		<div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
<div class="container-fluid">
	<div class="row">
		<div class="col-sm-12 col-md-3 col-lg-3">			
			<button type="button" class="btn btn-raised btn-info btn-block" onclick="javascript:recentTransactions(1);">Recent Entries</a></button>					
		</div>
		<div class="col-sm-12 col-md-3 col-lg-3">			
			<button type="button" class="btn btn-raised btn-info btn-block" onclick="javascript:daybookModal();">Create Journal</button>
		</div>
		<div class="col-sm-12 col-md-2 col-lg-2">			
			<button type="button" class="btn btn-raised btn-info btn-block" onclick="javascript:ledgerModal();">Ledger</button>
		</div>
		<div class="col-sm-12 col-md-2 col-lg-2">			
			<button type="button" class="btn btn-raised btn-info btn-block"  onclick="jaivascript:tbModal();">Trial Balance</button>
		</div>
		<div class="col-sm-12 col-md-2 col-lg-2">			
			<button type="button" class="btn btn-raised btn-info btn-block" onclick="javascript:bsModal();">Balance Sheet</a></button>					
		</div>
	</div>
	<br />
	<div class="row">
