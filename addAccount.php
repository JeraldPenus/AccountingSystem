...
<br><br><br><br><br><br><br><br><h4 style="font-size: 50px;margin-bottom: 0px;margin-top: 0px;padding-left: 30px;">Account Details</h4>
</section>
			...
			<div class="row">
				<div class="col-sm-12 col-lg-12">
					...
					<div class="form-group" id="openingbalancetr" name="openingbalancetr">
						...
						<input type="text" class="form-control" maxlength="15" name="openingbalance" id="openingbalance" value="<?php echo $modOpeningBalance; ?>"></input>
					</div>
					<?php } ?>
					...
					<div class="form-group" id="closingbalancetr" name="closingbalancetr">
						...
						<input type="text" class="form-control"  maxlength="15" name="closingbalance" id="closingbalance" value="<?php echo $modClosingBalance; ?>"></input>						
					</div>

					<div class="form-group">
						<label for="otherdetails">Other Details</label>
						<textarea name="otherdetails" class="form-control" id="otherdetails" maxlength="500"><?php echo $modOtherdetails; ?></textarea>
					</div>
					<button class="btn btn-raised btn-info" type="submit" name="submit" value="save">Save</button>
				</div>			
			</div>
			<?php 
...
<div class="container-fluid">
	<div class="row">
		<div class="col-sm-6 col-lg-6">
			<button type="button" class="btn btn-raised btn-info" onclick="javascript:createAccounts();"><span class="glyphicon glyphicon-plus"></span>&nbsp;Create Accounts</button>
		</div>
		<div class="col-sm-6 col-lg-6 text-right">
		<form class="form-inline" role="form">
				<input type="text" class="form-control" id="search" placeholder="Search" style="height: 40px;margin-bottom: 0px;"/>			
				<button type="button" class="btn btn-raised btn-info" onclick="javascript:searchAccounts();"><i class="material-icons">search</i>&nbsp;Search</button>
		</form>
		</div>		
	</div>
	<br />
